...
This repository contains both code and creative assets (artwork, sounds, etc.) that are licensed differently:

## Code License - MIT License

The code in this repository is licensed under the MIT License - see the [CODE_LICENSE.md](CODE_LICENSE.md) file for details.

## Creative Assets License - Custom License

All artwork, sound files, music, and other creative assets in this repository are subject to a custom license that prohibits redistribution, sharing, or reuse. See the [ASSETS_LICENSE.md](ASSETS_LICENSE.md) file for details.

## Attribution Requirements

When using any part of this project, you must provide proper attribution:
